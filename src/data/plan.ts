...
export const plan: Week[] = [
  {
    number: 1, isRecovery: false, workouts: [
      ...
      w(1, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x100m (1,000m total)'),
      w(1, 'Thu', 'bike', 'easy', 'Easy Bike', '40 min'),
      w(1, 'Fri', 'run', 'interval', 'Interval Run', '40 min w/ 6x20 sec relaxed sprints'),
      w(1, 'Sat', 'bike', 'endurance', 'Endurance Bike', '25 miles'),
      w(1, 'Sun', 'run', 'endurance', 'Endurance Run', '6 miles'),
  ...
  },
  {
    number: 2, isRecovery: false, workouts: [
      ...
      w(2, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 5x100m (1,100m total)'),
      w(2, 'Thu', 'bike', 'easy', 'Easy Bike', '45 min'),
      w(2, 'Fri', 'run', 'interval', 'Interval Run', '40 min w/ 8x20 sec relaxed sprints'),
      w(2, 'Sat', 'bike', 'endurance', 'Endurance Bike', '30 miles'),
      w(2, 'Sun', 'run', 'endurance', 'Endurance Run', '7 miles'),
  ...
  },
  {
    number: 3, isRecovery: false, workouts: [
      ...
      w(3, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 6x100m (1,200m total)'),
      w(3, 'Thu', 'bike', 'easy', 'Easy Bike', '45 min'),
      w(3, 'Fri', 'run', 'interval', 'Interval Run', '45 min w/ 8x20 sec relaxed sprints'),
      w(3, 'Sat', 'bike', 'endurance', 'Endurance Bike', '35 miles'),
      w(3, 'Sun', 'run', 'endurance', 'Endurance Run', '8 miles'),
  ...
  },
  {
    number: 4, isRecovery: true, workouts: [
      ...
      w(4, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 5x100m (1,200m total)'),
      w(4, 'Thu', 'bike', 'easy', 'Easy Bike', '45 min'),
      w(4, 'Fri', 'run', 'interval', 'Interval Run', '40 min w/ 6x20 sec relaxed sprints'),
      w(4, 'Sat', 'bike', 'endurance', 'Endurance Bike', '30 miles'),
      w(4, 'Sun', 'run', 'endurance', 'Endurance Run', '6 miles'),
  ...
  },
  {
    number: 5, isRecovery: false, workouts: [
      ...
      w(5, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x150m (1,500m total)'),
      w(5, 'Thu', 'bike', 'easy', 'Easy Bike', '45 min'),
      w(5, 'Fri', 'run', 'interval', 'Interval Run', '40 min w/ 6x1 min fast'),
      w(5, 'Sat', 'bike', 'endurance', 'Endurance Bike', '40 miles'),
      w(5, 'Sun', 'run', 'endurance', 'Endurance Run', '9 miles'),
  ...
  },
  {
    number: 6, isRecovery: false, workouts: [
      ...
      w(6, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x200m (1,600m total)'),
      w(6, 'Thu', 'bike', 'easy', 'Easy Bike', '45 min'),
      w(6, 'Fri', 'run', 'tempo', 'Tempo Run', '45 min w/ last 15 min comfortably hard'),
      w(6, 'Sat', 'bike', 'endurance', 'Endurance Bike', '45 miles'),
      w(6, 'Sun', 'run', 'endurance', 'Endurance Run', '10 miles'),
  ...
  },
  {
    number: 7, isRecovery: false, workouts: [
      ...
      w(7, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 5x150m (1,700m total)'),
      w(7, 'Thu', 'bike', 'easy', 'Easy Bike', '50 min'),
      w(7, 'Fri', 'run', 'interval', 'Interval Run', '40 min w/ 10x1 min fast uphill'),
      w(7, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '50 miles easy bike + 10-min easy run', true, '10-min easy run'),
      w(7, 'Sun', 'run', 'endurance', 'Endurance Run', '11 miles'),
  ...
  },
  {
    number: 8, isRecovery: true, workouts: [
      ...
      w(8, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 8x100m (1,500m total)'),
      w(8, 'Thu', 'bike', 'easy', 'Easy Bike', '45 min'),
      w(8, 'Fri', 'run', 'tempo', 'Tempo Run', '45 min w/ last 15 min comfortably hard'),
      w(8, 'Sat', 'bike', 'endurance', 'Endurance Bike', '40 miles'),
      w(8, 'Sun', 'run', 'endurance', 'Endurance Run', '8 miles'),
  ...
  },
  {
    number: 9, isRecovery: false, workouts: [
      ...
      w(9, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x250m (1,900m total)'),
      w(9, 'Thu', 'bike', 'easy', 'Easy Bike', '50 min'),
      w(9, 'Fri', 'run', 'interval', 'Interval Run', '45 min w/ 8x2 min fast'),
      w(9, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '55 miles easy bike + 10-min easy run', true, '10-min easy run'),
      w(9, 'Sun', 'run', 'endurance', 'Endurance Run', '12 miles'),
  ...
  },
  {
    number: 10, isRecovery: false, workouts: [
      ...
      w(10, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 6x150m (2,100m total)'),
      w(10, 'Thu', 'bike', 'easy', 'Easy Bike', '55 min'),
      w(10, 'Fri', 'run', 'tempo', 'Tempo Run', '50 min w/ last 20 min comfortably hard'),
      w(10, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '60 miles easy bike + 15-min easy run', true, '15-min easy run'),
      w(10, 'Sun', 'run', 'endurance', 'Endurance Run', '10 miles'),
  ...
  },
  {
    number: 11, isRecovery: false, workouts: [
      ...
      w(11, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 5x200m (2,300m total)'),
      w(11, 'Thu', 'bike', 'easy', 'Easy Bike', '1 hr'),
      w(11, 'Fri', 'run', 'interval', 'Interval Run', '45 min w/ 8x2 min fast'),
      w(11, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '65 miles easy bike + 10-min easy run', true, '10-min easy run'),
      w(11, 'Sun', 'run', 'endurance', 'Endurance Run', '13 miles'),
  ...
  },
  {
    number: 12, isRecovery: true, workouts: [
      ...
      w(12, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 12x100m (1,800m total)'),
      w(12, 'Thu', 'bike', 'easy', 'Easy Bike', '50 min'),
      w(12, 'Fri', 'run', 'tempo', 'Tempo Run', '40 min w/ last 12 min comfortably hard'),
      w(12, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '50 miles easy bike + 15-min easy run', true, '15-min easy run'),
      w(12, 'Sun', 'run', 'endurance', 'Endurance Run', '10 miles'),
  ...
  },
  {
    number: 13, isRecovery: false, workouts: [
      ...
      w(13, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x300m (2,500m total)'),
      w(13, 'Thu', 'bike', 'easy', 'Easy Bike', '1 hr'),
      w(13, 'Fri', 'run', 'interval', 'Interval Run', '50 min w/ 10x2 min fast'),
      w(13, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '70 miles easy bike + 10-min easy run', true, '10-min easy run'),
      w(13, 'Sun', 'run', 'endurance', 'Endurance Run', '14 miles'),
  ...
  },
  {
    number: 14, isRecovery: false, workouts: [
      ...
      w(14, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 2x400m, 4x100m (2,600m total)'),
      w(14, 'Thu', 'bike', 'easy', 'Easy Bike', '1 hr 15 min'),
      w(14, 'Fri', 'run', 'tempo', 'Tempo Run', '1 hr w/ last 20 min comfortably hard'),
      w(14, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '55 miles easy bike + 20-min easy run', true, '20-min easy run'),
      w(14, 'Sun', 'run', 'endurance', 'Endurance Run', '11 miles'),
  ...
  },
  {
    number: 15, isRecovery: false, workouts: [
      ...
      w(15, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x300m, 4x100m (2,800m total)'),
      w(15, 'Thu', 'bike', 'easy', 'Easy Bike', '1 hr 15 min'),
      w(15, 'Fri', 'run', 'interval', 'Interval Run', '55 min w/ 5x3 min fast'),
      w(15, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '85 miles easy bike + 10-min easy run', true, '10-min easy run'),
      w(15, 'Sun', 'run', 'endurance', 'Endurance Run', '16 miles'),
  ...
  },
  {
    number: 16, isRecovery: true, workouts: [
      ...
      w(16, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 2x400m, 4x100m (2,300m total)'),
      w(16, 'Thu', 'bike', 'easy', 'Easy Bike', '1 hr'),
      w(16, 'Fri', 'run', 'tempo', 'Tempo Run', '50 min w/ last 15 min comfortably hard'),
      w(16, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '50 miles easy bike + 15-min easy run', true, '15-min easy run'),
      w(16, 'Sun', 'run', 'endurance', 'Endurance Run', '10 miles'),
  ...
  },
  {
    number: 17, isRecovery: false, workouts: [
      ...
      w(17, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x400m (3,000m total)'),
      w(17, 'Thu', 'bike', 'easy', 'Easy Bike', '1 hr 20 min'),
      w(17, 'Fri', 'run', 'interval', 'Interval Run', '1 hr w/ 3x5 min fast'),
      w(17, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '100 miles easy bike + 10-min easy run', true, '10-min easy run'),
      w(17, 'Sun', 'run', 'endurance', 'Endurance Run', '18 miles'),
  ...
  },
  {
    number: 18, isRecovery: false, workouts: [
      ...
      w(18, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x300m, 4x100m (3,000m total)'),
      w(18, 'Thu', 'bike', 'easy', 'Easy Bike', '1 hr 30 min'),
      w(18, 'Fri', 'run', 'tempo', 'Tempo Run', '1 hr w/ last 25 min comfortably hard'),
      w(18, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '70 miles easy bike + 1-hour easy run', true, '1-hour easy run'),
      w(18, 'Sun', 'run', 'easy', 'Easy Run', '5 miles'),
  ...
  },
  {
    number: 19, isRecovery: false, workouts: [
      ...
      w(19, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x400m (2,600m total)'),
      w(19, 'Thu', 'bike', 'easy', 'Easy Bike', '1 hr'),
      w(19, 'Fri', 'run', 'interval', 'Interval Run', '45 min w/ 6x2 min fast'),
      w(19, 'Sat', 'bike', 'endurance', 'Endurance Bike + T-Run', '50 miles easy bike + 10-min easy run', true, '10-min easy run'),
      w(19, 'Sun', 'run', 'endurance', 'Endurance Run', '10 miles'),
  ...
  },
  {
    number: 20, isRecovery: false, workouts: [
      ...
      w(20, 'Thu', 'swim', 'interval', 'Interval Swim', 'MS: 4x300m (1,600m total)'),
      w(20, 'Thu', 'bike', 'easy', 'Easy Bike', '30 min'),
      w(20, 'Fri', 'run', 'easy', 'Easy Run', '30 min'),
